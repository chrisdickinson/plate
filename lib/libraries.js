...
DefaultTagLibrary.default_library = {
    ...
    'now':require('./tags/now').NowNode.parse,
...
DefaultFilterLibrary.default_library = {
    ...
    'date':require('./filters/date').date,
    ...
    'escape':require('./filters/escape').escape,
    ...
    'force_escape':require('./filters/force_escape').force_escape,
