...
(function(global) {
        ...
        render:function(context, callback) {
            this.filtervar(context, function(err, data) {
                if(err) {
                    ...
                    var isSafe = data instanceof utils.SafeString;
        ...
        var length = this.nodes.length,
            ...
            eterator = function(err, data) {
                ...
                if(err) {
                    ...
                    ++index;
                    if(index < length) {
                        // release control of the process momentarily 
                        setTimeout(function() {
    ...
    exporter = global.getExporter('nodes');

    exporter('Node', Node);
    exporter('FilterNode', FilterNode);
    exporter('NodeList', NodeList);
