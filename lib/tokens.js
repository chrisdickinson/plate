...
(function(global) {
    ...
    exporter = global.getExporter('tokens');
    exporter('CommentToken', CommentToken);
    exporter('FilterToken', FilterToken);
    exporter('TagToken', TagToken);
    exporter('TextToken', TextToken);
